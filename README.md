...
I co-founded PickupCard and helped take it from zero to the App Store in about a month. It helps organizers and venues run and fill pickup matches, while players build persistent, community-rated player cards.
...
A production Next.js website I designed and built for a real service business.

### Ambient Connection

A private iOS project I started while learning native Apple development, built with SwiftUI, WidgetKit, MapKit, WeatherKit, and a local-first App Group architecture.
...
Python · TypeScript · JavaScript · Swift · Java · React · Next.js · Vue · Flask · FastAPI · SQL
